  ...
  return (
    <div className="flex flex-col min-h-screen">
      ...
      <section className="relative w-full h-[500px] overflow-hidden">
        {/* Gradient Background */}
        <div className="absolute inset-0 bg-gradient-to-r from-[#2E1B5B] to-[#7A2048] z-0"></div>

        {/* Building image on the right */}
        <div className="absolute right-0 top-0 h-full w-[600px] z-10">
          <Image
            src="/hero-building.jpg.png"
            alt="Modern office building"
            fill
            className="object-cover object-right rounded-bl-[50px]"
            priority
          />
        </div>
        ...
        <div className="container mx-auto px-4 pt-32 relative z-30">
          <div className="max-w-xl">
            <h1 className="text-5xl font-bold text-white ml-20  mb-8">GCC as a Service</h1>
            <Link
              href="#"
              className="inline-flex items-center justify-center ml-20 rounded-md bg-white px-6 py-3 text-sm font-medium text-[#2E1B5B] shadow-sm hover:bg-gray-100 transition-colors"
            >
              Get Started
            </Link>
          </div>
