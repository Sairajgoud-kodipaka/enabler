  ...
  return (
    <div className="flex flex-col min-h-screen bg-[#F8F9FB]">
      ...
      <Reveal delay={0}>
        <section className="relative w-full h-[420px] md:h-[480px] overflow-hidden rounded-b-3xl">
          ...
          <div className="relative z-10 flex flex-col justify-center h-full px-6 md:px-0 max-w-2xl mx-auto md:ml-20">
            ...
            <Link href="#" className="inline-block bg-white text-[#0A1E40] font-semibold px-4 py-2 rounded shadow hover:bg-gray-100 transition-colors w-auto self-start">Get started</Link>
          </div>
        </section>
      </Reveal>
      ...
      <Reveal delay={0.1}>
        <section className="relative py-12 md:py-16 bg-white">
          ...
          <div className="relative z-10 max-w-6xl mx-auto px-4">
            ...
            <div className="mt-8">
            <Link href="#" className="inline-block bg-white text-[#2E1B5B] font-semibold px-4 py-2 rounded shadow hover:bg-gray-100 transition-colors w-auto self-start">Get Started</Link>
            </div>
          </div>
        </section>
      </Reveal>
      ...
      <div className="w-full flex items-center justify-start p-6">
        <Image src="/Enablr-logo.png" alt="Enablr Logo" width={160} height={48} className="h-12 w-auto" priority />
      </div>
    </div>
  )
}
